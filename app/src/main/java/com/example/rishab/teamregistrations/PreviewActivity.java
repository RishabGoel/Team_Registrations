...
//        overridePendingTransition(R.anim.move,0);
    ...
    public String handle_response(String responseText) {
        ...
        try {
            ...
            if (message.matches("Data not posted!"))
                return "The Required Fields are Missing.\nRegistration is Unsuccessful!";
            else if (message.matches("Registration completed"))
                return "Registration is Successful\nGood luck for the course!";
            else if (message.matches("User already registered"))
                return "One or more users with given details have already registered!\nRegistration is Unsuccessful";
